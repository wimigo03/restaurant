...
Route::prefix('cargos')->name('cargos.')->middleware(['auth:sanctum',config('jetstream.auth_session'),'verified',])->group(function () {
    Route::get('/', 'CargoController@index')->name('index')->middleware('can:cargos.index');
    Route::get('/search', 'CargoController@search')->name('search')->middleware('can:cargos.index');
    Route::get('/get_datos_cargo/{id}', 'CargoController@getDatosCargo')->name('get.datos.cargo')->middleware('can:cargos.index');
    Route::get('/get_datos_cargo_by_empresa', 'CargoController@getDatosCargoByEmpresa')->name('get.datos.cargo.by.empresa');
