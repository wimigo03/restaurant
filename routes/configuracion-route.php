...
Route::prefix('configuracion')->name('configuracion.')->middleware(['auth:sanctum',config('jetstream.auth_session'),'verified',])->group(function () {
    ...
    Route::get('/', 'ConfiguracionController@index')->name('index')->middleware('can:configuracion.index');
    Route::get('/search', 'ConfiguracionController@search')->name('search')->middleware('can:configuracion.index');
    Route::get('/create', 'ConfiguracionController@create')->name('create')->middleware('can:configuracion.create');
