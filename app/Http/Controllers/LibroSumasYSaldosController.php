...
use App\Exportar\LibroSumasYSaldosFExcel;
use DB;
use PDF;

class LibroSumasYSaldosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('libro_sumas_y_saldos.index', compact('icono','header','empresas','estados_comprobantes'));
    }
    ...
    public function search(Request $request)
    {
        ...
        try{
            ...
            ini_set('max_execution_time','-1');
                ...
                return view('libro_sumas_y_saldos.index', compact('icono','header','fecha_i','fecha_f','comprobantes','empresa','plan_cuentas','plan_cuentas_codigo','plan_cuentas_ids'));
        } catch (\Throwable $th) {
    ...
    public function excel(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $plan_cuentas_ids = $datos_sumas_y_saldos['plan_cuentas_ids'];
                $empresa = $datos_sumas_y_saldos['empresa'];
            return Excel::download(new LibroSumasYSaldosFExcel($fecha_i,$fecha_f,$comprobantes,$empresa,$plan_cuentas,$plan_cuentas_codigo,$plan_cuentas_ids),'Libro_SumasYSaldos.xlsx');
        } catch (\Throwable $th) {
            return view('errors.500');
        }finally{
            ini_restore('memory_limit');
    ...
    public function pdf(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $plan_cuentas_ids = $datos_sumas_y_saldos['plan_cuentas_ids'];
                $empresa = $datos_sumas_y_saldos['empresa'];
                $pdf = PDF::loadView('libro_sumas_y_saldos.pdf',compact(['fecha_i','fecha_f','comprobantes','empresa','plan_cuentas','plan_cuentas_codigo','plan_cuentas_ids']));
