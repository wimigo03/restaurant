...
use App\Exportar\LibroMayorCuentaYAuxiliarFExcel;
use DB;
use PDF;

class LibroMayorCuentaYAuxiliarFController extends Controller
{
    ...
    public function index()
    {
        ...
        $estados_comprobantes = ComprobanteF::ESTADOS_SEARCH;
        return view('libro_mayor_cuenta_general_y_auxiliar_f.index', compact('icono','header','empresas','estados_comprobantes'));
    }
    ...
    public function search(Request $request)
    {
        ...
        try{
            ...
            ini_set('max_execution_time','-1');
                ...
                return view('libro_mayor_cuenta_general_y_auxiliar_f.index', compact('icono','header','empresa','fecha_i','fecha_f','plan_cuenta','comprobantes','saldo_cuenta','saldo_final_cuenta','total_debe_cuenta','total_haber_cuenta','saldo_auxiliar','saldo_final_auxiliar','plan_cuenta_auxiliar','total_debe_auxiliar','total_haber_auxiliar'));
        } catch (\Throwable $th) {
    ...
    public function pdf(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $pdf = PDF::loadView('libro_mayor_cuenta_general_y_auxiliar_f.pdf',compact(['empresa','fecha_i','fecha_f','plan_cuenta','comprobantes','saldo_cuenta','saldo_final_cuenta','total_debe_cuenta','total_haber_cuenta','saldo_auxiliar','saldo_final_auxiliar','plan_cuenta_auxiliar','total_debe_auxiliar','total_haber_auxiliar']));
