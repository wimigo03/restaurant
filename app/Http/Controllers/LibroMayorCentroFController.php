...
use App\Exportar\LibroMayorCentroFExcel;
use DB;
use PDF;

class LibroMayorCentroFController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('libro_mayor_centro_f.index', compact('icono','header','empresas','estados_comprobantes'));
    }
    ...
    public function search(Request $request)
    {
        ...
        try{
            ...
            ini_set('max_execution_time','-1');
                ...
                return view('libro_mayor_centro_f.index', compact('icono','header','empresa','fecha_i','fecha_f','comprobantes','sub_centro','total_debe','total_haber'));
        } catch (\Throwable $th) {
    ...
    public function excel(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $total_debe = $libro_mayor_por_centro['total_debe'];
                $total_haber = $libro_mayor_por_centro['total_haber'];
            return Excel::download(new LibroMayorCentroFExcel($empresa,$fecha_i,$fecha_f,$comprobantes,$sub_centro,$total_debe,$total_haber),'Libro_Mayor_Por_Centro.xlsx');
        } catch (\Throwable $th) {
            return view('errors.500');
        }finally{
            ini_restore('memory_limit');
    ...
    public function pdf(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $total_debe = $libro_mayor_por_centro['total_debe'];
                $total_haber = $libro_mayor_por_centro['total_haber'];
                $pdf = PDF::loadView('libro_mayor_centro_f.pdf',compact(['empresa','fecha_i','fecha_f','comprobantes','sub_centro','total_debe','total_haber']));
