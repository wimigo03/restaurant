...
use App\Exportar\LibroMayorCuenta199FExcel;
use DB;
use PDF;

class LibroMayorCuenta199FController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('libro_mayor_cuenta_199_f.index', compact('icono','header','empresas','estados_comprobantes'));
    }
    ...
    public function search(Request $request)
    {
        ...
        try{
            ...
            ini_set('max_execution_time','-1');
                ...
                return view('libro_mayor_cuenta_199_f.index', compact('icono','header','empresa','fecha_i','fecha_f','plan_cuenta1','plan_cuenta2','comprobantes','saldos_cuentas','total_debe','total_haber'));
        } catch (\Throwable $th) {
    ...
    public function excel(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $total_debe = $datos_mayor199['total_debe'];
                $total_haber = $datos_mayor199['total_haber'];
            return Excel::download(new LibroMayorCuenta199FExcel($empresa,$fecha_i,$fecha_f,$plan_cuenta1,$plan_cuenta2,$comprobantes,$saldos_cuentas,$total_debe,$total_haber),'Libro_Mayor_Cuenta_1A99.xlsx');
        } catch (\Throwable $th) {
            return view('errors.500');
        }finally{
            ini_restore('memory_limit');
    ...
    public function pdf(Request $request)
    {
        ...
        try {
            ...
            ini_set('max_execution_time','-1');
                ...
                $total_debe = $datos_mayor199['total_debe'];
                $total_haber = $datos_mayor199['total_haber'];
                $pdf = PDF::loadView('libro_mayor_cuenta_199_f.pdf',compact(['empresa','fecha_i','fecha_f','plan_cuenta1','plan_cuenta2','comprobantes','saldos_cuentas','total_debe','total_haber']));
