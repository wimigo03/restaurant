...
class LibroSumasYSaldosExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_sumas_y_saldos.excel',compact('fecha_i','fecha_f','comprobantes','empresa','plan_cuentas','plan_cuentas_codigo','plan_cuentas_ids'));
    }
}
