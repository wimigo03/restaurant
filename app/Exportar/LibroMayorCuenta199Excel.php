...
class LibroMayorCuenta199Excel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_mayor_cuenta_199.excel',compact('empresa','fecha_i','fecha_f','plan_cuenta1','plan_cuenta2','comprobantes','saldos_cuentas','total_debe','total_haber'));
    }
}
