...
class LibroMayorAuxiliarGeneralExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_mayor_auxiliar_general.excel',compact('libro_mayor_auxiliar_general','comprobantes','empresa','plan_cuenta_auxiliar','saldo','saldo_final','total_debe','total_haber','fecha_i','fecha_f'));
    }
}
