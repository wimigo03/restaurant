...
class LibroMayorCentroExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_mayor_centro.excel',compact('empresa','fecha_i','fecha_f','comprobantes','sub_centro','total_debe','total_haber'));
    }
}
