...
class LibroMayorCentroCuentaFExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_mayor_centro_cuenta_f.excel',compact('empresa','fecha_i','fecha_f','comprobantes','sub_centro','plan_cuenta','total_debe','total_haber'));
    }
}
