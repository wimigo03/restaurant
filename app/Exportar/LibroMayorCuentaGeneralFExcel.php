...
class LibroMayorCuentaGeneralFExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro_mayor_cuenta_general_f.excel',compact('libro_mayor_cuenta_general','comprobantes','fecha_i','fecha_f','saldo','saldo_final','empresa','plan_cuenta','total_debe','total_haber'));
    }
}
