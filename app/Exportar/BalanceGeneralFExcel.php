...
class BalanceGeneralFExcel implements FromView,ShouldAutoSize{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('balance_general_f.excel',compact('empresa','ingresos','costos','gastos','nroMaxColumna','total','totales','fecha_f'));
    }
}
