...
@section('scripts')
    ...
    <script>
        ...
        function excel(){
            var id = $("#empresa_id").val();
            var url = "{{ route('libro.mayor.auxiliar.general.excel',':id') }}";
            $("#form").attr('action', url);
            url = url.replace(':id',id);
            window.location.href = url;
            $("#form").submit();
        ...
        function pdf(){
            var id = $("#empresa_id").val();
            var url = "{{ route('libro.mayor.auxiliar.general.pdf',':id') }}";
            $("#form").attr('action', url);
            url = url.replace(':id',id);
            window.location.href = url;
            $("#form").submit();
        ...
        function cambiarf(){
            ...
            $(".spinner-btn").show();
            var id = $("#empresa_id").val();
            var url = "{{ route('libro.mayor.auxiliar.general.f.index',':id') }}";
            url = url.replace(':id',id);
            window.location.href = url;
        }
    </script>
