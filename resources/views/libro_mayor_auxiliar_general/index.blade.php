...
@section('breadcrumb')
    ...
    <span>Libro Mayor por Cuenta General Auxiliar</span>
@endsection
@section('content')
    @include('libro_mayor_auxiliar_general.partials.search')
    @include('libro_mayor_auxiliar_general.partials.table')
@endsection
@section('scripts')
    @parent
    ...
    <script>
        ...
        function getPlanCuentasAuxiliares(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-auxiliar-general/get_plancuentasauxiliares',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function search(){
            var url = "{{ route('libro.mayor.auxiliar.general.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.mayor.auxiliar.general.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.mayor.auxiliar.general.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
