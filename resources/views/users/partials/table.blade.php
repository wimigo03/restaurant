                                ...
                                <div class="d-flex justify-content-center">
                                    @can('users.editar')
                                        <span class="tts:left tts-slideIn tts-custom" aria-label="Modificar" style="cursor: pointer;">
                                            <a href="{{ route('users.editar',$datos->id) }}" class="badge-with-padding badge badge-warning mr-1">
                                    ...
                                    @can('users.habilitar')
                                        @if (App\Models\User::ESTADOS[$datos->estado] == 'HABILITADO')
                                            <span class="tts:left tts-slideIn tts-custom" aria-label="Dehabilitar" style="cursor: pointer;">
                                                <a href="{{ route('users.deshabilitar',$datos->id) }}" class="badge-with-padding badge badge-danger mr-1">
                                        ...
                                        @else
                                            <span class="tts:left tts-slideIn tts-custom" aria-label="Habilitar" style="cursor: pointer;">
                                                <a href="{{ route('users.habilitar',$datos->id) }}" class="badge-with-padding badge badge-success mr-1">
