<div class="form-group row">
    <div class="col-md-4 pr-1 font-verdana-bg">
        ...
        <input type="text" value="{{ $user->cliente != null ? $user->cliente->razon_social : '#' }}" class="form-control font-verdana-bg" disabled>
    </div>
    <div class="col-md-3 pr-1 pl-1 font-verdana-bg">
        ...
        <input type="text" value="{{ $user->empresa != null ? $user->empresa->nombre_comercial : '#' }}" class="form-control font-verdana-bg" disabled>
    </div>
    <div class="col-md-5 pl-1 font-verdana-bg">
        ...
        <input type="text" value="{{ $user->cargo != null ? $user->cargo->nombre : '#' }}" class="form-control font-verdana-bg" disabled>
    </div>
</div>
<div class="form-group row">
    <div class="col-md-5 pr-1 font-verdana-bg">
        <label for="nombre" class="d-inline">Nombre</label>
        <input type="text" name="nombre" value="{{ $user->name }}" class="form-control font-verdana-bg">
    </div>
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        <label for="username" class="d-inline">Usuario</label>
        <input type="text" value="{{ $user->username }}" class="form-control font-verdana-bg" disabled>
    </div>
    <div class="col-md-3 pr-1 pl-1 font-verdana-bg">
        <label for="email" class="d-inline">Correo Electronico</label>
        <input type="text" name="email" value="{{ $user->email }}" class="form-control font-verdana-bg">
    </div>
    <div class="col-md-2 pl-1 font-verdana-bg">
        <label for="estado" class="d-inline">Estado</label>
        <input type="text" value="{{ $user->status }}" class="form-control font-verdana-bg" disabled>
    </div>
</div>
<div class="form-group row">
