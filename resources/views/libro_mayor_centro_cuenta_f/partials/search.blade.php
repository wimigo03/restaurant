    ...
    <form action="#" method="get" id="form">
        <div class="form-group row font-roboto-12">
            ...
            <div class="col-md-2 pr-1 pl-1">
                ...
                <input type="text" name="fecha_i" value="{{ old('fecha_i') }}" id="fecha_i" placeholder="dd-mm-aaaa" class="form-control font-roboto-12" data-language="es">
            </div>
            <div class="col-md-2 pr-1 pl-1">
                <label for="fecha_f" class="d-inline">Fecha Final</label>
                <input type="text" name="fecha_f" value="{{ old('fecha_f') }}" id="fecha_f" placeholder="dd-mm-aaaa" class="form-control font-roboto-12" data-language="es">
            </div>
            <div class="col-md-2 pr-1 pl-1">
        ...
        <div class="form-group row font-roboto-12">
            <div class="col-md-5 px-1 pr-1">
                <label for="centro" class="d-inline">Centro</label>
                <select id="centro_id" class="form-control select2">
                </select>
            </div>
            <div class="col-md-5 pr-1 pl-1">
                <label for="subcentro" class="d-inline">SubCentro</label>
                <select name="sub_centro_id" id="sub_centro_id" class="form-control select2">
                </select>
            </div>
        </div>
        <div class="form-group row font-roboto-12">
            <div class="col-md-6 px-1 pr-1">
                <label for="cuenta_contable" class="d-inline">Cuenta Contable</label>
                <select id="plan_cuenta_id" name="plan_cuenta_id" class="form-control select2">
                </select>
            </div>
        </div>
        <div class="form-group row font-roboto-12">
            <div class="col-md-12 px-1">
                @can('libro.mayor.cuenta.general.f.index')
                    <span class="tts:right tts-slideIn tts-custom" aria-label="Cambiar" style="cursor: pointer;">
                        <span class="btn btn-outline-warning font-roboto-12" onclick="cambiari();">
