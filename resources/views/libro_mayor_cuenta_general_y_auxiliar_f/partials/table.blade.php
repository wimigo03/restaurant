@if (isset($comprobantes))
    ...
    <div class="form-group row font-roboto-12">
        ...
        <div class="col-md-2 pr-1 pl-1">
            <b>Saldo Inicial Auxiliar:</b>
        </div>
        <div class="col-md-2 pr-1 pl-1">
            {{ number_format($saldo_auxiliar,2,'.',',') }}
        </div>
        <div class="col-md-1 pr-1 pl-1">
            <b>Total Debe:</b>
        </div>
        <div class="col-md-2 px-1 pl-1">
            {{ number_format($total_debe_cuenta,2,'.',',') }}
        </div>
    </div>
    <div class="form-group row font-roboto-12">
        <div class="col-md-1 px-1 pr-1">
        ...
        <div class="col-md-2 pr-1 pl-1">
            {{ number_format($saldo_final_cuenta,2,'.',',') }}
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <b>Saldo Final Auxiliar:</b>
        </div>
        <div class="col-md-2 pr-1 pl-1">
            {{ number_format($saldo_final_auxiliar,2,'.',',') }}
        </div>
        <div class="col-md-1 pr-1 pl-1">
            <b>Total Haber:</b>
        </div>
        <div class="col-md-2 px-1 pl-1">
            {{ number_format($total_haber_cuenta,2,'.',',') }}
        </div>
    </div>
