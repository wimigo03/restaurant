    ...
    <form action="#" method="post" id="form">
        ...
        <div class="form-group row">
            <div class="col-md-3 px-1 pr-1 font-roboto-12">
                ...
                <select name="empresa_id" id="empresa_id" class="form-control form-control-sm select2">
                    <option value="">-</option>
            ...
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                ...
                <input type="text" name="dolar_oficial" value="{{ $tipo_cambio->dolar_oficial }}" id="dolar_oficial" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="ufv" class="d-inline">Ufv</label>
                <input type="text" name="ufv" value="{{ $tipo_cambio->ufv }}" id="ufv" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
        ...
        <div class="form-group row">
            <div class="col-md-2 px-1 pr-1 font-roboto-12">
                ...
                <div class="select2-container--obligatorio" id="obligatorio_moneda_id">
                    <select name="moneda_id" id="moneda_id" class="form-control form-control-sm select2" onchange="obligatorio();">
                        <option value="">-</option>
            ...
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                ...
                <input type="text" name="fecha" value="{{ old('fecha') }}" id="fecha" placeholder="dd-mm-aaaa" class="form-control form-control-sm font-roboto-12 obligatorio" data-language="es" oninput="obligatorio();">
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="tipo" class="d-inline">Tipo</label>
                <div class="select2-container--obligatorio" id="obligatorio_tipo">
                    <select name="tipo" id="tipo" class="form-control form-control-sm font-roboto-12 select2" onchange="obligatorio();">
            ...
            <div class="col-md-3 px-1 pl-1 font-roboto-12">
                ...
                <input type="text" name="entregado_recibido" value="{{ old('entregado_recibido') }}" id="entregado_recibido" class="form-control form-control-sm font-roboto-12 obligatorio intro" oninput="this.value = this.value.toUpperCase(); obligatorio();">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-9 px-1 pr-1 font-roboto-12">
                <label for="concepto" class="d-inline">Concepto</label>
                <input type="text" name="concepto" value="{{ old('concepto') }}" id="concepto" class="form-control form-control-sm font-roboto-12 obligatorio intro" oninput="this.value = this.value.toUpperCase(); obligatorio();">
            </div>
        </div>
        <div class="row">
