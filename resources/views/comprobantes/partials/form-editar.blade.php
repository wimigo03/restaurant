    ...
    <form action="#" method="post" id="form">
        ...
        <div class="form-group row">
            <div class="col-md-3 px-1 pr-1 font-roboto-12">
                ...
                <input type="text" value="{{ $comprobante->empresa->nombre_comercial }}" id="empresa" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="dolar_oficial" class="d-inline">Tipo de Cambio</label>
                <input type="text" value="{{ $comprobante->tipo_cambio }}" id="dolar_oficial" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="ufv" class="d-inline">Ufv</label>
                <input type="text" value="{{ $comprobante->ufv }}" id="ufv" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="user" class="d-inline">Usuario</label>
                <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                <input type="text" value="{{ Auth::user()->username }}" id="username" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-2 px-1 pr-1 font-roboto-12">
                ...
                <input type="text" id="nro_comprobante" value="{{ $comprobante->nro_comprobante }}" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="moneda" class="d-inline">Moneda</label>
                <input type="text" value="{{ $comprobante->datos_moneda->nombre }}" id="moneda" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="fecha" class="d-inline">Fecha</label>
                <input type="text" name="fecha" value="{{ \Carbon\Carbon::parse($comprobante->fecha)->format('d-m-Y') }}" id="fecha" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-2 pr-1 pl-1 font-roboto-12">
                <label for="tipo" class="d-inline">Tipo</label>
                <input type="text" value="{{ App\Models\Comprobante::TIPOS[$comprobante->tipo] }}" id="tipo" class="form-control form-control-sm font-roboto-12" disabled>
            </div>
            <div class="col-md-3 px-1 pl-1 font-roboto-12">
                ...
                <input type="text" name="entregado_recibido" value="{{ $comprobante->entregado_recibido }}" id="entregado_recibido" class="form-control form-control-sm font-roboto-12 obligatorio intro" oninput="this.value = this.value.toUpperCase(); obligatorio();">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-9 px-1 pl-1 font-roboto-12">
                <label for="concepto" class="d-inline">Concepto</label>
                <input type="text" name="concepto" value="{{ $comprobante->concepto }}" id="concepto" class="form-control form-control-sm font-roboto-12 obligatorio intro" oninput="this.value = this.value.toUpperCase(); obligatorio();">
            </div>
        </div>
        <div class="row">
        ...
        <div class="form-group row">
            <div class="col-md-3 px-1 pr-1 font-roboto-12">
                ...
                <select id="centro_id" class="form-control form-control-sm select2">
                    <option value="">-</option>
            ...
            <div class="col-md-3 pr-1 pl-1 font-roboto-12">
                ...
                <select id="sub_centro_id" class="form-control form-control-sm select2">
                </select>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-5 px-1 pr-1 font-roboto-12">
                ...
                <select id="plan_cuenta_id" class="form-control form-control-sm select2">
                    <option value="">-</option>
            ...
            <div class="col-md-4 pr-1 pl-1 font-roboto-12 tiene-auxiliar">
                ...
                <select id="auxiliar_id" class="form-control form-control-sm select2">
                    <option value="">-</option>
            ...
            <div class="col-md-1 pr-1 pl-1 font-roboto-12">
                ...
                <input type="text" placeholder="0" id="debe" class="form-control form-control-sm font-roboto-12 input-formatear-numero">
            </div>
            <div class="col-md-1 px-1 pl-1 font-roboto-12">
                <label for="haber" class="d-inline">Haber (Bs.)</label>
                <input type="text" placeholder="0" id="haber" class="form-control form-control-sm font-roboto-12 input-formatear-numero">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-9 px-1 pr-1 font-roboto-12">
                ...
                <input type="text" id="glosa" class="form-control form-control-sm font-roboto-12" oninput="this.value = this.value.toUpperCase();">
            </div>
            <div class="col-md-1 pr-1 pl-1 font-roboto-12">
                <label for="debe" class="d-inline">Debe ($u$)</label>
                <input type="text" placeholder="0" id="debe_sus" class="form-control form-control-sm font-roboto-12 input-formatear-numero" readonly>
            </div>
            <div class="col-md-1 pr-1 pl-1 font-roboto-12">
                <label for="haber" class="d-inline">Haber ($u$)</label>
                <input type="text" placeholder="0" id="haber_sus" class="form-control form-control-sm font-roboto-12 input-formatear-numero" readonly>
            </div>
            <div class="col-md-1 px-1 pl-1 font-roboto-12 text-right">
                <br>
                <span class="tts:left tts-slideIn tts-custom" aria-label="Registrar">
                    <button type="button" class="btn btn-success btn-sm" onclick="agregar_detalle();">
