                            ...
                            @can('zonas.habilitar')
                                @if($datos->status == "HABILITADO")
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Deshabilitar" style="cursor: pointer;">
                                        <a href="{{ route('zonas.deshabilitarBySucursal',$datos->id) }}" class="badge-with-padding badge badge-danger">
                                ...
                                @else
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Habilitar" style="cursor: pointer;">
                                        <a href="{{ route('zonas.habilitarBySucursal',$datos->id) }}" class="badge-with-padding badge badge-success">
