...
@section('breadcrumb')
    ...
    <span><a href="{{ route('plan_cuentas.auxiliar.index') }}">Plan Cuentas Auxiliares</a><span>&nbsp;/&nbsp;
    <span>Modificar</span>
@endsection
<style>
...
@section('content')
    @include('plan_cuentas_auxiliares.partials.form-editar')
...
@section('scripts')
    ...
    <script>
        ...
        function confirmar(){
            var url = "{{ route('plan_cuentas.auxiliar.update') }}";
