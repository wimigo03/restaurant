...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if($("#tipo_contrato >option:selected").val() == "PLAZO FIJO"){
                $("#form_fecha_contrato_fijo").show();
            }else{
            ...
            if($('#checkboxOne').prop('checked')) {
                ...
                document.getElementById('fiscal').value = 'F';
            }else{
                $('#collapseOne').collapse('hide');
                document.getElementById('fiscal').value = '';
                document.getElementById('fecha_ingreso_fiscal').value = '';
                document.getElementById('haber_basico_fiscal').value = '0';
                document.getElementById('tipo_bono_fiscal').value = '';
                document.getElementById('bono_fiscal').value = '0';
                $('#afp_id').val('').trigger('change');
            ...
            if($('#checkboxTwo').prop('checked')) {
                ...
                document.getElementById('interno').value = 'I';
            }else{
                $('#collapseTwo').collapse('hide');
                document.getElementById('interno').value = '';
                document.getElementById('fecha_ingreso_interna').value = '';
                document.getElementById('haber_basico_interno').value = '0';
                document.getElementById('tipo_bono_interno').value = '';
                document.getElementById('bono_interno').value = '0';
                $("#fecha_ingreso_fiscal").addClass('obligatorio');
                $("#haber_basico_fiscal").addClass('obligatorio');
                $("#obligatorio_afp_id").addClass('select2-container--obligatorio');
            }
            ...
            if($('#checkboxTree').prop('checked')) {
                ...
                document.getElementById('servicio').value = 'S';
            }else{
                $('#collapseTree').collapse('hide');
                document.getElementById('servicio').value = '';
                document.getElementById('fecha_ingreso_servicio').value = '';
                document.getElementById('haber_basico_servicio').value = '0';
                document.getElementById('tipo_bono_servicio').value = '';
                document.getElementById('bono_servicio').value = '0';
