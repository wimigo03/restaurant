...
<div class="form-group row">
    <div class="col-md-4 pr-1 font-verdana-bg">
        ...
        <input type="text" name="primer_nombre" value="{{ old('primer_nombre') }}" id="primer_nombre" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
    <div class="col-md-4 pr-1 pl-1 font-verdana-bg">
        <label for="segundo_nombre" class="d-inline">Segundo Nombre</label>
        <input type="text" name="segundo_nombre" value="{{ old('segundo_nombre') }}" class="form-control font-verdana-bg" oninput="this.value = this.value.toUpperCase()">
    </div>
    <div class="col-md-4 pl-1 font-verdana-bg">
        <label for="foto" class="d-inline">Foto</label>
        <input type="file" name="foto" class="form-control font-verdana-bg">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-4 pr-1 font-verdana-bg">
        <label for="ap_paterno" class="d-inline">Apellido Paterno</label>
        <input type="text" name="ap_paterno" value="{{ old('ap_paterno') }}" id="ap_paterno" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
    <div class="col-md-4 pr-1 pl-1 font-verdana-bg">
        <label for="ap_materno" class="d-inline">Apellido Materno</label>
        <input type="text" name="ap_materno" value="{{ old('ap_materno') }}" id="ap_materno" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2 pr-1 font-verdana-bg">
        ...
        <div class="select2-container--obligatorio" id="obligatorio_nacionalidad_id">
            <select name="nacionalidad" id="nacionalidad" class="form-control font-verdana-bg select2">
    ...
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        ...
        <input type="text" name="ci_run" value="{{ old('ci_run') }}" id="ci_run" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        <label for="extension" class="d-inline">Extension</label>
        <div class="select2-container--obligatorio" id="obligatorio_extension">
            <select name="extension" id="extension" class="form-control font-verdana-bg select2" onchange="verificarObligatorio();">
                <option value="">--Seleccionar--</option>
    ...
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        ...
        <input type="text" name="fecha_nac" value="{{ old('fecha_nac') }}" id="fecha_nac" placeholder="dd/mm/aaaa" class="form-control font-verdana-bg obligatorio" data-language="es" onkeyup=countChars(this); oninput="verificarObligatorio();">
    </div>
    <div class="col-md-1 pr-1 pl-1 font-verdana-bg">
        <label for="edad" class="d-inline">Edad</label>
        <input type="text" name="edad_nac" value="{{ old('edad_nac') }}" id="edad_nac" class="form-control font-verdana-bg" readonly>
    </div>
    <div class="col-md-3 pl-1 font-verdana-bg">
        <label for="lugar_nacimiento" class="d-inline">Lugar Nacimiento</label>
        <input type="text" name="lugar_nacimiento" value="{{ old('lugar_nacimiento') }}" class="form-control font-verdana-bg" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2 pr-1 font-verdana-bg">
        ...
        <div class="select2-container--obligatorio" id="obligatorio_sexo">
            <select name="sexo" id="sexo" class="form-control font-verdana-bg select2 obligatorio" onchange="verificarObligatorio();">
                <option value="">--Seleccionar--</option>
    ...
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        ...
        <div class="select2-container--obligatorio" id="obligatorio_licencia_conducir">
            <select name="licencia_conducir" id="licencia_conducir" class="form-control font-verdana-bg select2 obligatorio" onchange="verificarObligatorio();">
                <option value="">--Seleccionar--</option>
    ...
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg" id="form_licencia_categoria">
        ...
        <select name="licencia_categoria" id="licencia_categoria" class="form-control font-verdana-bg select2">
            <option value="">--Seleccionar--</option>
...
<div class="form-group row">
    <div class="col-md-2 pr-1 font-verdana-bg">
        ...
        <input type="text" name="celular" value="{{ old('celular') }}" id="celular" class="form-control font-verdana-bg obligatorio" onkeypress="return valideNumberSinDecimal(event);" oninput="verificarObligatorio();">
    </div>
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        <label for="telefono" class="d-inline">Telefono Fijo</label>
        <input type="text" name="telefono" value="{{ old('telefono') }}" id="telefono" class="form-control font-verdana-bg" onkeypress="return valideNumberSinDecimal(event);">
    </div>
    <div class="col-md-6 pr-1 pl-1 font-verdana-bg">
        <label for="domicilio" class="d-inline">Domicilio</label>
        <input type="text" name="domicilio" value="{{ old('domicilio') }}" id="domicilio" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
    </div>
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        <label for="e_civil" class="d-inline">Estado Civil</label>
        <div class="select2-container--obligatorio" id="obligatorio_estado_civil">
            <select name="estado_civil" id="estado_civil" class="form-control font-verdana-bg select2 obligatorio" onchange="verificarObligatorio();">
                <option value="">--Seleccionar--</option>
