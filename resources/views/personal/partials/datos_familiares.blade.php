...
<div class="form-group row">
    <div class="col-md-5 pr-1 font-verdana-bg">
        ...
        <input type="text" value="{{ old('nombre_familiar_input') }}" id="nombre_familiar_input" class="form-control font-verdana-bg" oninput="this.value = this.value.toUpperCase()">
    </div>
    ...
    <div class="col-md-2 pr-1 pl-1 font-verdana-bg">
        ...
        <input type="text" value="{{ old('edad_familiar_input') }}" id="edad_familiar_input" class="form-control font-verdana-bg" onkeypress="return valideNumberSinDecimal(event);">
    </div>
    <div class="col-md-2 pl-1 font-verdana-bg">
        <label for="telefono_familiar_input" class="d-inline">Telefono</label>
        <input type="text" value="{{ old('telefono_familiar_input') }}" id="telefono_familiar_input" class="form-control font-verdana-bg" onkeypress="return valideNumberSinDecimal(event);">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-3 pr-1 font-verdana-bg" id="form_otro_tipo">
        <label for="otro_tipo_familiar_input" class="d-inline">Otro Tipo</label>
        <input type="text" value="{{ old('otro_tipo_familiar_input') }}" id="otro_tipo_familiar_input" class="form-control font-verdana-bg" oninput="this.value = this.value.toUpperCase()">
    </div>
    <div class="col-md-3 pr-1 pl-1 font-verdana-bg">
...
<div class="form-group row">
    <div class="col-md-12 pl-1 font-verdana-bg text-right">
