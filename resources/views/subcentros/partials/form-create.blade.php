<form action="#" method="post" id="form">
    ...
    <div class="form-group row align-items-center">
        <div class="col-md-5 px-1 pr-1 font-roboto-12 text-right">
            <label for="centro" class="d-inline">Centro Contable:</label>
        </div>
        <div class="col-md-3 pr-1 pl-1 font-roboto-12">
            <select id="centro_id" name="centro_id" class="form-control select2">
            </select>
        </div>
    </div>
    <div class="form-group row align-items-center">
        <div class="col-md-5 px-1 pr-1 font-roboto-12 text-right">
            <label for="nombre" class="d-inline">Nombre del sub centro contable:</label>
        </div>
