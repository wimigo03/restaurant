...
@section('scripts')
    ...
    <script>
        ...
        function eliminarItem(thiss,asiento_automatico_detalle_id){
            var tr = $(thiss).parents("tr:eq(0)");
            tr.remove();
            if (typeof asiento_automatico_detalle_id !== "undefined") {
                eliminar_registro(asiento_automatico_detalle_id);
            }
        }
        ...
        function eliminar_registro(id){
            $.ajax({
                type: 'GET',
                url: '/asiento-automatico/eliminar_registro/'+id,
                dataType: 'json',
                data: {
                    id: id
                },
