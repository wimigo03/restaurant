...
@section('breadcrumb')
    ...
    <span><a href="{{ route('comprobantef.index') }}"> Listar comprobantes</a><span>&nbsp;/&nbsp;
...
@section('content')
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9 px-1 pl-1 font-roboto-13">
        ...
        <div class="col-md-6 px-1 pl-1 font-roboto-13 text-right">
            @can('comprobantef.pdf')
                <span class="tts:left tts-slideIn tts-custom" aria-label="Exportar a Pdf" style="cursor: pointer;">
                    <button class="btn btn-sm btn-danger font-roboto-12 " type="button" onclick="pdf();">
