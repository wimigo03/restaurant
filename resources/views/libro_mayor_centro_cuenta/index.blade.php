...
@endsection
@section('content')
    @include('libro_mayor_centro_cuenta.partials.search')
    @include('libro_mayor_centro_cuenta.partials.table')
@endsection
@section('scripts')
    @parent
    ...
    <script>
        ...
        function getCentros(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-centro-cuenta/get_centros',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function getSubCentros(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-centro-cuenta/get_subcentros',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function getPlanCuentas(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-centro-cuenta/get_plancuentas',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function search(){
            var url = "{{ route('libro.mayor.centro.cuenta.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.mayor.centro.cuenta.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.mayor.centro.cuenta.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
