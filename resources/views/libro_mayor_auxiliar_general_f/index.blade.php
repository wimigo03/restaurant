...
@section('scripts')
    ...
    <script>
        ...
        function search(){
            ...
            var url = "{{ route('libro.mayor.auxiliar.general.f.search',':id') }}";
        ...
        function excel(){
            var id = $("#empresa_id").val();
            var url = "{{ route('libro.mayor.auxiliar.general.f.excel',':id') }}";
            $("#form").attr('action', url);
            url = url.replace(':id',id);
            window.location.href = url;
            $("#form").submit();
        ...
        function pdf(){
            var id = $("#empresa_id").val();
            var url = "{{ route('libro.mayor.auxiliar.general.f.pdf',':id') }}";
            $("#form").attr('action', url);
            url = url.replace(':id',id);
            window.location.href = url;
            $("#form").submit();
