<div class="form-group row font-roboto-12" id="subMenuCategorias">
    @can('categorias.index')
        <div class="col-md-3 px-1 sub-botones-producto">
            <a href="{{ route('categorias.index',['empresa_id' => $empresa->id, 'status_platos' => '[]', 'status_insumos' => '[]']) }}" class="btn btn-info btn-block font-roboto-12">
                <i class="fas fa-poll-h fa-fw fa-beat"></i>&nbsp;Categorias
            </a>
        </div>
    @endcan
    @can('unidades.index')
    ...
    @can('productos.index')
        <div class="col-md-3 pr-1 sub-botones-producto">
            <a href="{{ route('productos.index',['empresa_id' => $empresa->id]) }}" class="btn btn-outline-secondary btn-block font-roboto-12">
