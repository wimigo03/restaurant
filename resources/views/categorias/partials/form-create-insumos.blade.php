...
<div class="form-group row">
    <div class="col-md-5 pr-1 font-verdana-bg">
        ...
        <input type="text" value="{{ $categoria->nombre }}" class="form-control font-verdana-bg" disabled>
    </div>
...
<div class="form-group row">
    ...
    <div class="col-md-3 pr-1 pl-1 font-verdana-bg">
        ...
        <input type="hidden" name="tipo" value="2" class="form-control font-verdana-bg">
        <input type="text" value="INSUMOS" class="form-control font-verdana-bg" disabled>
    </div>
