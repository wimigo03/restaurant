                ...
                <div class="row">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        @if (count($estado_platos) == 1)
                            <div class="form-group row" id="btn_todos_los_platos">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Mostrar Todos" style="cursor: pointer;">
                                        <span class="btns font-verdana text-primary" onclick="todos_los_platos();">
                        ...
                        @else
                            <div class="form-group row" id="btn_solo_habilitados_platos">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Mostrar Solo Habilitados" style="cursor: pointer;">
                                        <span class="btns font-verdana text-success" onclick="solo_habilitados_platos();">
                                            &nbsp;<i class="fa-solid fa-2x fa-users-gear"></i>&nbsp;
                                        </span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group row" style="margin-top: -15px;" id="btn_platos_master">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Crear Categoria Master" style="cursor: pointer;">
                                        <span class="btns font-verdana text-secondary" onclick="crear_platos_master();">
                            ...
                            <div class="form-group row" style="margin-top: -15px;" id="btn_sub_platos_master">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Crear SubCategoria" style="cursor: pointer;">
                                        <span class="btns font-verdana text-secondary" onclick="crear_platos();">
                        ...
                        @can('categorias.habilitar')
                            <div class="form-group row" style="margin-top: -10px;" id="btn_deshabilitar_platos">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Deshabilitar" style="cursor: pointer;">
                                        <span class="btns font-verdana text-danger" onclick="deshabilitar_platos();">
                        ...
                        @endcan
                        @can('categorias.habilitar')
                            <div class="form-group row" style="margin-top: -10px;" id="btn_habilitar_platos">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Habilitar" style="cursor: pointer;">
                                        <span class="btns font-verdana text-success" onclick="habilitar_platos();">
                        ...
                        @can('categorias.modificar')
                            <div class="form-group row" style="margin-top: -10px;" id="btn_modificar_platos">
                                <div class="col-md-12">
                                    <span class="tts:left tts-slideIn tts-custom" aria-label="Modificar" style="cursor: pointer;">
                                        <span class="btns font-verdana text-secondary" onclick="modificar();">
                                            &nbsp;<i class="fa-solid fa-2x fa-users-gear"></i>&nbsp;
                                        </span>
                                    </span>
                                </div>
