    ...
    <form action="#" method="get" id="form">
        ...
        <div class="form-group row font-roboto-12">
            <div class="col-md-5 px-1 pl-1">
                <label for="cuenta_contable" class="d-inline">Cuenta Contable A</label>
                <select name="plan_cuenta_id1" id="plan_cuenta_id1" class="form-control select2">
                </select>
            </div>
            <div class="col-md-5 px-1 pl-1">
                <label for="cuenta_contable" class="d-inline">Cuenta Contable B</label>
                <select name="plan_cuenta_id2" id="plan_cuenta_id2" class="form-control select2">
                </select>
            </div>
        </div>
        <div class="form-group row font-roboto-12">
