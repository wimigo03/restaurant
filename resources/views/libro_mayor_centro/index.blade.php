...
@section('breadcrumb')
    ...
    <span>Libro Mayor por Centro</span>
@endsection
@section('content')
    @include('libro_mayor_centro.partials.search')
    @include('libro_mayor_centro.partials.table')
@endsection
@section('scripts')
    @parent
    ...
    <script>
        ...
        function getCentros(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-centro/get_centros',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function getSubCentros(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-centro/get_subcentros',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function search(){
            var url = "{{ route('libro.mayor.centro.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.mayor.centro.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.mayor.centro.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
