<div class="form-group row font-roboto-12" id="subMenuUnidades">
    ...
    @can('unidades.index')
        <div class="col-md-2 pr-1 sub-botones-producto">
            <a href="{{ route('unidades.index',['empresa_id' => $empresa->id]) }}" class="btn btn-info btn-block font-roboto-12">
                <i class="fas fa-balance-scale fa-fw fa-beat"></i>&nbsp;Unidades
            </a>
        </div>
    @endcan
    @can('productos.index')
