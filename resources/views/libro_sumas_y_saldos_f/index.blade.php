...
@section('breadcrumb')
    ...
    <span>Libro de Sumas y Saldos</span>
@endsection
@section('content')
    @include('libro_sumas_y_saldos_f.partials.search')
    @include('libro_sumas_y_saldos_f.partials.table')
@endsection
@section('scripts')
    @parent
    ...
    <script>
        ...
        function search(){
            var url = "{{ route('libro.sumas.y.saldos.f.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.sumas.y.saldos.f.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.sumas.y.saldos.f.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
