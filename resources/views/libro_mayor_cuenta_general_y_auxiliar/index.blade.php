...
@section('breadcrumb')
    ...
    <span>Libro Mayor por Cuenta y Auxiliar</span>
@endsection
@section('content')
    @include('libro_mayor_cuenta_general_y_auxiliar.partials.search')
    @include('libro_mayor_cuenta_general_y_auxiliar.partials.table')
@endsection
@section('scripts')
    @parent
    ...
    <script>
        ...
        function getPlanCuentas(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-cuenta-y-auxiliar/get_plancuentas',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function getPlanCuentasAuxiliares(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-cuenta-y-auxiliar/get_plancuentasauxiliares',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function search(){
            var url = "{{ route('libro.mayor.cuenta.y.auxiliar.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.mayor.cuenta.y.auxiliar.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.mayor.cuenta.y.auxiliar.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
