<form action="#" method="get" id="form">
    ...
    {{--<div class="form-group row">
        ...
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="numero" placeholder="--Numero--" value="{{ request('numero') }}" class="form-control font-roboto-bg intro" oninput="this.value = this.value.toUpperCase()">
        </div>
        <div class="col-md-2 pl-1">
            <input type="text" name="sillas" placeholder="--Sillas--" value="{{ request('sillas') }}" class="form-control font-roboto-bg intro" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-md-4 pr-1">
