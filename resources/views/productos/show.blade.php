...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="form-group row">
            <div class="col-md-12">
                <div class="card-header header">
                    <b>{{ $empresa->nombre_comercial }} - DETALLE DEL PRODUCTO</b>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 pr-1 font-verdana text-center">
            ...
            @if ($producto->foto_3 != null)
                <div class="col-md-4 pl-1 font-verdana text-center">
