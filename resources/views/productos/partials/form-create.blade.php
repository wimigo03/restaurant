<form action="#" method="post" id="form" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4 px-1 pl-1 font-roboto-12">
            ...
            <select id="categoria_id" name="categoria_id" class="form-control select2">
                <option value="">--Seleccionar--</option>
            </select>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-4 pr-1 pl-1 font-roboto-12">
            ...
            <input type="text" name="nombre_factura" value="{{ old('nombre_factura') }}" id="nombre_factura" class="form-control font-roboto-12" oninput="this.value = this.value.toUpperCase();">
        </div>
        <div class="col-md-2 pr-1 pl-1 font-roboto-12">
            <label for="codigo" class="d-inline">Codigo</label>
            <input type="text" name="codigo" value="{{ old('codigo') }}" id="codigo" class="form-control font-roboto-12" oninput="this.value = this.value.toUpperCase();" readonly>
        </div>
    </div>
    <div class="form-group row">
