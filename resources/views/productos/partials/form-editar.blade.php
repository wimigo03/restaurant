<form action="#" method="post" id="form" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <div class="col-md-4 pr-1 font-verdana-bg">
            ...
            <input type="text" name="nombre" value="{{ $producto->nombre }}" id="nombre" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
        </div>
        <div class="col-md-5 pr-1 pl-1 font-verdana-bg">
            <label for="nombre_factura" class="d-inline">Nombre Factura</label>
            <input type="text" name="nombre_factura" value="{{ $producto->nombre_factura }}" id="nombre_factura" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
        </div>
        <div class="col-md-3 pl-1 font-verdana-bg">
            <label for="codigo" class="d-inline">Codigo</label>
            <input type="text" name="codigo" value="{{ $producto->codigo }}" id="codigo" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();" readonly>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-9 pr-1 pl-1 font-verdana-bg">
            <label for="detalle" class="d-inline">Descripcion</label>
            <input type="text" name="detalle" value="{{ $producto->detalle }}" id="detalle" class="form-control font-verdana-bg obligatorio" oninput="this.value = this.value.toUpperCase(); verificarObligatorio();">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-md-4 pr-1 font-verdana-bg">
        ...
        <div class="col-md-8 pr-1 pl-1 font-verdana-bg text-center">
