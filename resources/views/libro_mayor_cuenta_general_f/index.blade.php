...
@section('scripts')
    ...
    <script>
        ...
        function getPlanCuentas(id,CSRF_TOKEN){
            $.ajax({
                type: 'GET',
                url: '/libro-mayor-cuenta-general-f/get_plancuentas',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
        ...
        function search(){
            var url = "{{ route('libro.mayor.cuenta.general.f.search') }}";
        ...
        function excel() {
            var url = "{{ route('libro.mayor.cuenta.general.f.excel') }}";
            $(".btn").hide();
        ...
        function pdf() {
            var url = "{{ route('libro.mayor.cuenta.general.f.pdf') }}";
            $(".btn").hide();
            $(".spinner-btn-send").show();
            var form = $("#form");
            var formData = form.serialize();
