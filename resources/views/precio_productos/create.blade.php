...
@section('breadcrumb')
    ...
    <span><a href="{{ route('precio.productos.index') }}"> Precio Productos</a><span>&nbsp;/&nbsp;
    <span>Registrar</span>
@endsection
<style>
...
@section('content')
    ...
    @include('precio_productos.partials.form-create')
...
@section('scripts')
    ...
    <script>
        ...
        function confirmar(){
            var url = "{{ route('tipo.precios.store') }}";
        ...
        function cancelar(){
            ...
            var url = "{{ route('tipo.precio.index',':id') }}";
